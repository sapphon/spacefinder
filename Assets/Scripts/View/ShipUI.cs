...
namespace View
{
    public class ShipUI : MonoBehaviour
    {
        ...
        {
            int movesUntilNextTurn = helmPhaseController.getMovementState().MovesUntilNextTurn();
        ...
        {
            int movesRemaining = helmPhaseController.getMovementState().MovesRemaining();
        ...
        {
            this.advanceIndicator.color = helmPhaseController.getMovementState().MayAdvance() ? Color.green : Color.red;
        }
    
        private void SetTurnUIColor()
        {
            var turnColor = helmPhaseController.getMovementState().MayTurn() ? Color.green : Color.red;
